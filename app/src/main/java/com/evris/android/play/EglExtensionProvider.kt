                    ...
                    for (i in 0 until cf[0]) {
                        ...
                        if (a3[0] != EGL10.EGL_SLOW_CONFIG) {
                            ...
                            if (1 and a3[0] != 0) {
                                ...
                                if (1 and a3[0] != 0) addExtensionsForConfig(egl10, display, configs[i], a1, null, glExtensions)
                                if (4 and a3[0] != 0) addExtensionsForConfig(egl10, display, configs[i], a1, a2, glExtensions)
                            }
                        }
                    }
                }
    ...
    private fun addExtensionsForConfig(
        ...
        if (eglSurface === EGL10.EGL_NO_SURFACE) {
            ...
            if (!TextUtils.isEmpty(s)) {
                ...
                set.addAll(listOf(*split).subList(0, split.size))
            }
